...
do
	...
	do		
		sed "s/#namespace/$namespace/g;s/#mongodbi/$j/g;s/#rsi/$i/g" mongod-rc/template/mongod.pvc.rc.yaml > mongod-rc/tmp/mongodb-$j-rs$i.yaml
...
do
	...
	do
		sed "s/#namespace/$namespace/g;s/#mongodbi/$j/g;s/#cfgi/$i/g" cfgsvr-rc/template/cfgsvr.pvc.rc.yaml > cfgsvr-rc/tmp/mongodb-$j-cfg$i.yaml
...
do
	sed "s/#namespace/$namespace/g;s/#cfgi/$i/g;s/#cfg-ips/$cfg_ips/g" mongos-rc/template/mongos.pvc.rc.yaml > mongos-rc/tmp/mongos-$i.yaml
